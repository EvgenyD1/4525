# класс будет родительским по отношению к классам Student и Lecturer
class BaseMethod:
    def avg(self):
        average = []
...
# Создание студента №1
some_student = Student('Anton', 'ivanov', 'man')
some_student.courses_in_progress += ['Python', 'Git']
some_student.finished_courses += ['Введение в программирование']

# Создание студента №2
other_student = Student('Peter', 'Smiroff', 'man')
...
other_reviewer  = Reviewer('Mick', 'Jagger')
other_reviewer.courses_attached += ['Python']
other_reviewer.courses_attached += ['Git']

# Создание лектора №1
some_lecturer = Lecturer('Donald', 'Trump')
some_lecturer.courses_attached += ['Python']
some_lecturer.courses_attached += ['Git']

# Создание лектора №2
other_lecturer = Lecturer('Ilon', 'Musk')
...
some_reviewer.rate_hw(other_student, 'Git', 2)
...
some_student.rate_lec(other_lecturer, 'Python', 7)
some_student.rate_lec(other_lecturer, 'Python', 9)
some_student.rate_lec(other_lecturer, 'Git', 5)
